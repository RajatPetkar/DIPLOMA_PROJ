        ...
        <>
          <center>
            <div className='col-md-7'>
              <div className='canvas' id='canvas' style={{ display: 'none' }} />
              <img className='mt-5' src={Profile} style={{ height: '100px' }} alt='Img'/>
              <h2 className="fs-1 mt-3">Please SignIn</h2>
          ...
          <>
            <div className='row'>
              <div className='col-md-3'>
                ...
                <textarea rows={3} ref={textFromAudio} value={transcript} placeholder='Speech input ...' className='w-100 input-style' readOnly />
