...
import Girl from '../../Assets/images/element/07.png'
            ...
            <div className="container">
              <div className="row align-items-center g-5">
                <div className="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                  ...
                  <h1 className="mb-0 display-6">Limitless learning at your 
                    <span className="position-relative"> fingertips
                      <span className="position-absolute top-50 start-50 translate-middle ms-3 z-index-n1">
                        <svg width="270px" height="62.1px" enableBackground="new 0 0 366 62.1" viewBox="0 0 366 62.1" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="my-4 lead">Discover the World of Signs: Your Premier Online Learning Platform for Sign Language</p>
                  ...
                  <div className="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                    {/* <a id="downloadLink" className="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0"  download="./edu-port.apk">Click here to download the APK</a> */}
  
                    <div className="d-flex align-items-center justify-content-center py-2 ms-0 ms-sm-4">
                      <a data-glightbox data-gallery="office-tour" href="#" className="btn btn-round btn-primary-shadow mb-0 overflow-visible me-7"> 
